...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	...
	\pagestyle{empty}  % žádné číslo stránky
...
\begin{figure}[h!]
	\centering %% příkaz, který ti obrázek zarovná na střed
	\includegraphics[width=0.8\textwidth]{image/loginregister.png} %% vložení samotného obrátku
...
Aplikace rozlišuje tři role: admina, učitele a student. Systém je založen na Django skupinách, přičemž skupiny „Teacher“ a „Student“ jsou v aplikaci předem definovány. Noví uživatelé jsou při registraci automaticky zařazeni do skupiny „Student“.
...
Omezování přístupu je řešeno kontrolou přihlášení a oprávnění přímo v kódu aplikace. V šablonách se používá filtr {% if user|is_teacher %}, který zobrazuje funkce pro správu aplikace pouze učitelům a adminům.
...
\begin{figure}[h!]
	\centering %% příkaz, který ti obrázek zarovná na střed
	\includegraphics[width=0.8\textwidth]{image/spravaKvizu.png} %% vložení samotného obrátku
...
\begin{figure}[h!]
	\centering %% příkaz, který ti obrázek zarovná na střed
	\includegraphics[width=1.05\textwidth]{image/ucZak.png} %% vložení samotného obrátku
...
\begin{figure}[H]
	...
	\label{fig:Odpovědi Student} %% označení až budeš chtít na obrázek odkazovat
\end{figure}
\newpage
...
\begin{figure}[H]
	\centering %% příkaz, který ti obrázek zarovná na střed
	\includegraphics[width=0.65\textwidth]{image/odpovedzak.png} %% vložení samotného obrátku
	\caption{Stránka po odeslání odpovědi z pohledu studenta} %% popisek obrázku, nezapomeň na citace!
...
\begin{figure}[H]
	\centering %% příkaz, který ti obrázek zarovná na střed
	\includegraphics[width=0.3\textwidth]{image/zolik.png} %% vložení samotného obrátku
...
\end{figure}
	...
	Aplikace umožňuje učitelům vytvářet a spravovat vzdělávací materiály, které jsou propojeny s~konkrétními kvízy. Ke správě těchto materiálů slouží redakční systém Wagtail CMS, který je součástí aplikace.
	...
	\begin{figure}[h!]
		...
		\caption{Struktura podstránek} %% popisek obrázku, nezapomeň na citace!
